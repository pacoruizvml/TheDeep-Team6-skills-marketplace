...
export const AGENT_TOOLS: Record<string, { title: string; purpose: string; tools: string[]; cannot: string[] }> = {
  signal: { title: "1 · Signal-to-Audience Agent", purpose: "Detect actionable opportunity, choose strategy, qualify and size the audience, notify dealer.", tools: ["get_external_signals", "get_weather_alerts", "get_business_signals", "evaluate_opportunity", "compare_strategies", "build_audience", "get_audience", "get_dealer_breakdown", "notify_dealer", "get_dealer_reply"], cannot: ["write copy", "judge compliance", "approve", "stage journeys"] },
  ...
  compliance: { title: "3 · Compliance & Guardrails Agent (veto)", purpose: "Referee: audience, offer and claim guardrails. PASS / VETO + constraints / ESCALATE. Never rewrites.", tools: ["get_ruleset", "evaluate_audience_guardrails", "evaluate_offer_guardrails", "evaluate_campaign_claims", "submit_campaign_for_review"], cannot: ["write or edit copy", "approve", "stage journeys"] },
