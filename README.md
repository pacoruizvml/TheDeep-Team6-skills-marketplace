...
Marketplace `teamf` → plugin `teamf-bridgestone` → 10 skills:
...
| `teamf-bstn-ajo-email-template` | Step 5: on-brand Bridgestone email template in AJO from the compliance-PASSED content (standalone: built-in winter-storm brief) |
